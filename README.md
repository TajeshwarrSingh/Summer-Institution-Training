...
The Department of Computer Science and Engineering (CSE) conducted an introduction session for second-year students in the college auditorium. The session provided an overview of the department's functioning, academic policies, laboratories, and student activities. Faculty members explained the curriculum, internal assessment process, semester examinations, and the grading system, and all about the institutional training program. Students were also briefed on attendance requirements, projects, internships, and departmental expectations. The session concluded with an students moving to their respective labs. The students got a clear understanding of the department and its academic framework.
...
Faculty explained the fundamentals of reverse engineering, its applications in software analysis, debugging, malware analysis, and cybersecurity.
